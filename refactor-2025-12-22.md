...
- Uses `sanitize_id()` utility: lowercase, spaces→hyphens, alphanumeric/hyphens/underscores only
...
22. ✅ **Unified icon clicks** (mouse and keyboard follow same path, emit IconClicked)
23. ✅ **sanitize_id() utility** (centralized, reusable across widgets and user code)
24. ✅ **is_item_toggled()** (boolean getter, clearer than get_item_toggle)
